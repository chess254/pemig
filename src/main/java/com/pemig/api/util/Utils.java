...
public final class Utils {
    ...
    public static LoanDto fromLoanEntityToLoanDto(Loan loan) {
        return LoanDto.builder()
                ...
                .businessRegDocUrl(loan.getLoanDetails().getBusinessRegistrationDocumentUrl())
                .idOrPassportUrl(loan.getLoanDetails().getNationalIdOrPassportUrl())
                .payslipUrl(loan.getLoanDetails().getPayslipUrl())
