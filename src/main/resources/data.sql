...
INSERT IGNORE INTO `user` (`id`, `email_address`, `password`, `role`, created_by, created_date_time, last_modified_by, last_modified_date_time, county, description, first_name, middle_name, last_name, id_number, occupation, phone_number, primary_account_number, profile_pic, verified, birth_date) VALUES
    (10, 'admin@cards.com', '$2a$10$AUE6Db.6s4wSgeB3T89PlucPe7.2ql2lerT3qJ46L9Zrc/0BdTN8u', 'ADMIN', 'admin@cards.com','2023-08-28 09:43:43.000000', 'admin@cards.com','2023-08-28 09:43:43.000000', 'Nairobi', 'test description', 'admin', 'admid', 'adlast', '25213819', 'admins occupation', 0721542746, 1234567890, 'http://prof.pic', 1, '2023-08-28 09:43:43.000000');
