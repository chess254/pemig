            ...
            new Components()
                .addSchemas(
                    ...
                    new Schema<Map<String, String>>()
                        .addProperty(NAME_FILTER_STRING, new StringSchema().example("Card Name"))
                        .addProperty(COLOR_FILTER_STRING, new StringSchema().example("#000000"))
                        .addProperty(
                            STATUS_FILTER_STRING, new StringSchema().example("TODO"))
                        .addProperty(CREATING_USER_FILTER_STRING, new StringSchema().example("user@test.com"))
                        .addProperty(
                ...
                .addSchemas(
                    ...
                    new Schema<Map<String, String>>()
                        ...
                        .addProperty(COLOR_FILTER_STRING, new StringSchema().example("#FFFFFF"))
